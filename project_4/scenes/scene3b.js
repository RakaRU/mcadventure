function scene3b() {
  ...
  function draw0() {
    ...
    fill(50, 100, 70);
    textSize(20);
    text("Your arms give out and Mamara falls to the botttom of the well once", width/2, height/2 - 45);
    text("again. Shrecc decides to pick up the slack and grabs hold of the rope.", width/2, height/2 - 15);
    text("He yanks it in one go and Mamara shoots out of the well and", width/2, height/2 + 15);
    text("lands on the grassy knoll.", width/2, height/2 + 45);
  ...
  function draw3() {
    ...
    image(shrek, 150, 20, 400, 560);
      ...
      fill(50, 100, 70);
      textSize(20);
      text("Shrecc: Oh, would you look at that.", width/2, height - 95);
  ...
  function draw5() {
    ...
    image(shrek, 150, 20, 400, 560);
      ...
      fill(50, 100, 70);
      textSize(20);
      text("Shrecc: Uh, Shrecc. And this is MC.", width/2, height - 95);
  ...
  function draw6() {
    ...
    image(mamara2, 210, 170, 250, 350);
      ...
      fill(50, 100, 70);
      textSize(20);
      text("Mamara: Hello, Shrecc. How can I p-possibly repaaay you?", width/2, height - 95);
  ...
  function draw7() {
    ...
    fill(50, 100, 70);
    textSize(20);
    text("Shrecc: My buddy here needs help finding his sister.", width/2, height - 95);
  ...
  function draw9() {
    ...
    fill(50, 100, 70);
    textSize(20);
    text("Shrecc: MC's got a long lost sister. His evil parents threw", width/2, height - 107);
    text("him away when he was a boy.", width/2, height - 83);
  ...
  function draw11() {
    ...
    fill(50, 100, 70);
    textSize(20);
    text("Shrecc: That's our girl. Any clue where she is?", width/2, height - 95);
  ...
  function draw18() {
    ...
    fill(50, 100, 70);
    textSize(20);
    text("Mamara: Gooood luck on your journeeey. I hope you f-find your sissster.", width/2, height - 107);
    text("I guessss I'll go-o start my neeew life.", width/2, height - 83);
  ...
  function draw21() {
    ...
    fill(50, 100, 70);
    textSize(20);
    text("Shrecc: Where to MC?", width/2, height - 95);
  ...
  function draw28() {
      ...
      fill(50, 100, 70);
      textSize(20);
      text("You get up to run and your friend follows.", width/2, height/2);
  ...
  function draw30() {
      ...
      fill(50, 100, 70);
      textSize(20);
      text("Your friend turns to you in confusion.", width/2, height/2 - 15);
  ...
  function draw35() {
    ...
    fill(50, 100, 70);
    textSize(20);
    text("Zoku: I mean. My bad.", width/2, height - 95);
  ...
  function draw36() {
    ...
    fill(50, 100, 70);
    textSize(20);
    text("MC: It's fine.", width/2, height - 95);
  ...
  function draw45() {
    ...
    text("good game of beer pong.", width/2, height - 83);
