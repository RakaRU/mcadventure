function helpminimini() {
  ...
  this.draw = function() {
    ...
    text("the camera when the blue", width/2, height/2 - 35);
    text("ring is within the white", width/2, height/2);
    text("one to successfully hit", width/2, height/2 + 35);
    text("the paparazzi with the", width/2, height/2 + 70);
    text("snack.", width/2, height/2 + 105);
