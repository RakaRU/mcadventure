function scene4b() {
  ...
  function draw4() {
    image(party, 0, 0);
      ...
      fill(50, 100, 70);
      textSize(20);
      text("Zoku: Good luck, buddy. It will be a long journey to restore your honor.", width/2, height - 50);
      arrowsprite.position.x = 685;
      arrowsprite.position.y = 685;
  }
  ...
  function draw5() {
    image(party, 0, 0);
      ...
      fill(50, 100, 70);
      textSize(20);
      text("Zoku: I would know.", width/2, height - 50);
      arrowsprite.position.x = 685;
      arrowsprite.position.y = 685;
  }
  ...
  function draw28() {
    ...
    fill(50, 100, 70);
    textSize(20);
    text("Shrek: That's new.", width/2, height - 50);
    arrowsprite.position.x = 685;
    arrowsprite.position.y = 685;
  }
  ...
  function draw30() {
    ...
    fill(50, 100, 70);
    textSize(20);
    text("Zoku: Because you told us.", width/2, height - 50);
    arrowsprite.position.x = 685;
    arrowsprite.position.y = 685;
  }
  ...
  function draw35() {
    ...
    fill(50, 100, 70);
    textSize(20);
    text("Zoku: Not going to happen.", width/2, height - 50);
    arrowsprite.position.x = 685;
    arrowsprite.position.y = 685;
  }
  ...
  function draw37() {
    ...
    fill(50, 100, 70);
    textSize(20);
    text("Zoku charges Mike Al Sara.", width/2, height/2);
    arrowsprite.position.x = 620;
    arrowsprite.position.y = 435;
  }
  ...
  function draw38() {
    ...
    fill(50, 100, 70);
    textSize(20);
    text("He lets out a blast of fire but Mike is prepared", width/2, height/2 - 15);
    text("with a bucket of water to throw at him.", width/2, height/2 + 15);
    arrowsprite.position.x = 620;
    arrowsprite.position.y = 435;
  }
  ...
  function draw39() {
    ...
    fill(50, 100, 70);
    textSize(20);
    text("Mike: I'm not that weak! You think you could defeat me with such a weak ally?", width/2, height - 50);
    arrowsprite.position.x = 685;
    arrowsprite.position.y = 685;
  }
  ...
  function draw40() {
    ...
    fill(50, 100, 70);
    textSize(20);
    text("Mike: And that's not all. I have kidnapped your sister. If you don't join me", width/2, height - 65);
    text("as one of my underlings, you will never see her again.", width/2, height - 35);
    arrowsprite.position.x = 685;
    arrowsprite.position.y = 685;
  }
  ...
  function draw41() {
    ...
    fill(50, 100, 70);
    textSize(20);
    text("Mike Al Sara has defeated you.", width/2, height/2 - 30);
    text("You have no choice. Your sister is missing,", width/2, height/2);
    text("and you now work at Rosh forever.", width/2, height/2 + 30);
    arrowsprite.position.x = 620;
    arrowsprite.position.y = 435;
  }
