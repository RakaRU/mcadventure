function scene2a() {
  ...
  function draw2() {
      ...
      fill(50, 100, 70);
      textSize(20);
      text("Hennie: Thank you so much for your help, MC oppa. I'd love to help", width/2, height - 65);
      text("you look for your sister. Is that alright with you two?", width/2, height - 35);
  ...
  function draw3() {
      ...
      fill(50, 100, 70);
      textSize(20);
      text("Shrek: Of course.", width/2, height - 50);
  ...
  function draw4() {
      ...
      fill(50, 100, 70);
      textSize(20);
      text("Hennie: Really?", width/2, height - 50);
  ...
  function draw5() {
      ...
      fill(50, 100, 70);
      textSize(20);
      text("Shrecc: NO.", width/2, height - 50);
