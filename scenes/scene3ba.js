function scene3ba() {
  ...
  function draw20() {
    ...
    fill(50, 100, 70);
    textSize(20);
    text("MC: What's that supposed to mean?", width/2, height - 95);
  ...
  function draw22() {
    ...
    fill(50, 100, 70);
    textSize(20);
    text("Shrecc: Look at her in her raggedy old dress. You know. Honestly.", width/2, height - 107);
    text("What do you think, MC?", width/2, height - 83);
  ...
  function draw33() {
    ...
    fill(50, 100, 70);
    textSize(20);
    text("Shrecc: Would you look at that. She was just hungry.", width/2, height - 95);
  ...
  function draw36() {
    ...
    fill(50, 100, 70);
    textSize(20);
    text("Mamara: Who's that?", width/2, height - 95);
  ...
  function draw42() {
    ...
    fill(50, 100, 70);
    textSize(20);
    text("Mamara: *Get's under the table.*", width/2, height - 95);
  ...
  function draw47() {
    ...
    fill(50, 100, 70);
    textSize(20);
    text("Mamara: Why was he chasing us?", width/2, height - 95);
  ...
  function draw58() {
    ...
    fill(50, 100, 70);
    textSize(20);
    text("Mamara: And who are you?", width/2, height - 95);
