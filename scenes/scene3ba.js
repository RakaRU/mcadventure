function scene3ba() {
  ...
  function draw5() {
    ...
    fill(50, 100, 70);
    textSize(20);
      text("Shrecc: Uh, Shrecc. And this is MC.", width/2, height - 50);
  }
  ...
  function draw9() {
    ...
    fill(50, 100, 70);
    textSize(20);
    text("Shrecc: MC's got a long lost sister. His evil parents threw", width/2, height - 65);
    text("him away when he was a boy.", width/2, height - 35);
  ...
  function draw11() {
    ...
    fill(50, 100, 70);
    textSize(20);
    text("Shrecc: That's our girl. Any clue where she is?", width/2, height - 50);
  }
  ...
  function draw20() {
    ...
    fill(50, 100, 70);
    textSize(20);
    text("MC: What's that supposed to mean?", width/2, height - 50);
  }
  ...
  function draw22() {
    ...
    fill(50, 100, 70);
    textSize(20);
    text("Shrecc: Look at her in her raggedy old dress. You know. Honestly.", width/2, height - 65);
    text("What do you think, MC?", width/2, height - 35);
  }
  ...
  function draw27() {
    ...
    fill(50, 100, 70);
    textSize(20);
    text("Shrecc: Where to MC?", width/2, height - 50);
  }
  ...
  function draw33() {
    ...
    fill(50, 100, 70);
    textSize(20);
    text("Shrecc: Would you look at that. She was just hungry.", width/2, height - 50);
  }
  ...
  function draw36() {
    ...
    fill(50, 100, 70);
    textSize(20);
    text("Mamara: Who's that?", width/2, height - 50);
  }
  ...
  function draw42() {
    ...
    fill(50, 100, 70);
    textSize(20);
    text("Mamara: *Get's under the table.*", width/2, height - 50);
  }
  ...
  function draw47() {
    ...
    fill(50, 100, 70);
    textSize(20);
    text("Mamara: Why was he chasing us?", width/2, height - 50);
  }
  ...
  function draw58() {
    ...
    fill(50, 100, 70);
    textSize(20);
    text("Mamara: And who are you?", width/2, height - 50);
  }
