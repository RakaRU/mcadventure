function scene4ba() {
  ...
  function draw43() {
    ...
    fill(50, 100, 70);
    textSize(20);
    text("Shrecc walks up to a nearly defeated Mike.", width/2, height/2 - 30);
    text("Delivering the final blow,", width/2, height/2);
    text("he lets out a ripe one", width/2, height/2 + 30);
    arrowsprite.position.x = 620;
    arrowsprite.position.y = 435;
  }
